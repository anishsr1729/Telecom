      ...
      getDoc(docRef)
        .then((docSnap) => {
          if (docSnap.exists()) {
            ...
            // Check if the last name is 'admin'
            if (userData.lastName === 'admin') {
              window.location.href = 'admin-page/admin.html';
            }
            if (userData.lastName === 'manager') {
              window.location.href = 'admin-page/manager.html';
            }
            if (userData.lastName === 'staff') {
              window.location.href = 'admin-page/staff.html';
            }
